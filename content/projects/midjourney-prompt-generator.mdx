...
description: "Python script to generate a random prompt for Midjourney."
repository: itsbrex/midjourney-prompt-generator
url: https://github.com/itsbrex/midjourney-prompt-generator
date: "2023-05-07"
published: true
...
I made this to quickly create images for other projects I'm working on. It's a tool that generates random prompts for [Midjourney](https://midjourney.com/) based on a YAML file with options for different design elements.
